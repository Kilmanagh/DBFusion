...
{
    public class InfluxDbDatabase : IDatabase
    {
        private readonly DBFusion.Databases.InfluxDbDatabase _db;
        public InfluxDbDatabase(DbAuth auth) => _db = new DBFusion.Databases.InfluxDbDatabase(auth);
